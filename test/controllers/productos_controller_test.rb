...
class ProductosControllerTest < ActionController::TestCase
  ...
  test "should create producto" do
    assert_difference('Producto.count') do
      post :create, producto: { codigo: @producto.codigo, detalle: @producto.detalle, img: @producto.img, precio: @producto.precio, tipo: @producto.tipo }
    end
  ...
  test "should update producto" do
    patch :update, id: @producto, producto: { codigo: @producto.codigo, detalle: @producto.detalle, img: @producto.img, precio: @producto.precio, tipo: @producto.tipo }
    assert_redirected_to producto_path(assigns(:producto))
  end
